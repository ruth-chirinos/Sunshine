...
public  class ForecastFragment extends Fragment {
    ...
    * */
    ...
    //AsyncTask<Tipo variable de entrada
    //         ,El tipo de progress unit published during the bckground
    //         ,Tipo variable de salida>
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
    {
        ...
        protected String[] doInBackground(String... params)
        {
            ...
            //<!--End, 40 - JSON Parsing -->
            //return null only if there is any error
            return result;
        }
